...
public class CombatBalance {
    ...
    public static final int BASE_DAMAGE_BEAM_LARGE = BASE_DAMAGE * 4;
    public static final float BASE_SPEED_BEAM_LARGE = 2.5F;

    public static final int BASE_DAMAGE_BEAM = BASE_DAMAGE * 2;
    public static final float BASE_SPEED_BEAM = 2.5F;


    public static final int BASE_DAMAGE_MISSILE = BASE_DAMAGE * 3;
    public static final float BASE_SPEED_MISSILE = 2F;

    public static final int BASE_DAMAGE_MACHINEGUN = BASE_DAMAGE / 3;
